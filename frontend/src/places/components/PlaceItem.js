        ...
        <>
            ...
            >
                <div className="map-container">
                    <MapView center={props.coordinates} zoom={10} />
                </div>
            </Modal>
            <Modal
                show={showConfirmModal}
                onCancel={cancelDeleteWarningModalHandler}
                header="Are you sure"
                contentClass="place-item__modal-content"
                footerClass="place-item__modal-actions"
                footer={
                    <>
                        <Button
                            inverse
                            onClick={cancelDeleteWarningModalHandler}
                        >
                            CLOSE
                        </Button>
            ...
            >
                <p>Do you want to proceed delete this place? </p>
            </Modal>
                    ...
                    <div className="place-item__actions">
                        ...
                        {auth.userId === props.creatorId && (
                            <>
                                ...
                                <Button
                                    danger
                                    onClick={showDeleteWarningModalHandler}
                                >
                                    DELETE
                                </Button>
                            </>
